...
/**
 * Identical to ranked ff for now.
 *  - any ranked query can be wrapped by a threshold or a filter function.
 * 
 * @author sjh
 */
public class BooleanFeatureFactory extends FeatureFactory {
static String[][] sOperatorLookup = {
  ...
  public BooleanFeatureFactory(Parameters parameters) {
