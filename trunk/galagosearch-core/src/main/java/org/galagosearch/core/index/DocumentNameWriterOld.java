...
public class DocumentNameWriterOld implements Processor<NumberedDocumentData> {
    ...
    public DocumentNameWriterOld(TupleFlowParameters parameters) throws FileNotFoundException, IOException {
