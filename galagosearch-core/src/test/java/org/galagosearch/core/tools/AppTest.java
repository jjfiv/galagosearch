...
public class AppTest extends TestCase {
    ...
    public void testSimplePipeline() throws Exception {
        ...
        File corpusFile = File.createTempFile("galago", ".corpus");
        ...
        File indexFile = Utility.createTemporary();
        indexFile.delete();
        ...
        String queries =
            ...
            "</parameters>\n";
        File queryFile = Utility.createTemporary();
        ...
        assertEquals("9 Q0 59 1 -1.38562930 galago\n" +
