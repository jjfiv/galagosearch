    ...
    public DRMAAStageExecutor(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            if (args[i].startsWith("Xmx")) {
                ...
                nativeSpecification = args[i].replaceAll("^-ns=", "");
                nativeSpecification.replaceAll("(^\")|(\"$)", "");
                System.out.println(nativeSpecification);
            } else {
        ...
        try {
            ...
            for (int i = 0; i < jobPaths.size(); i++) {
                ...
                if (addNativeSpecification) {
                    template.setNativeSpecification(nativeSpecification);
                }
