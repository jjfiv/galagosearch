...
public class StructuredRetrievalTest extends TestCase {
  ...
  public void testWindow() throws FileNotFoundException, IOException, Exception {
    ...
    Parameters aParam = new Parameters();
    aParam.add("default", "a");
    aParam.add("part", "postings");
    Node aTerm = new Node("extents", aParam, new ArrayList(), 0);
    Parameters bParam = new Parameters();
    bParam.add("default", "b");
    bParam.add("part", "postings");
    Node bTerm = new Node("extents", bParam, new ArrayList(), 0);
    ...
    w.add("default", "5");
    Node wTerm = new Node("uw", w, wChildren, 0);

    ArrayList<Node> fChild = new ArrayList<Node>();
    fChild.add(wTerm);
    Parameters f = new Parameters();
    f.add("default", "dirichlet");
    f.add("mu", "1500");
    Node feature = new Node("feature", f, fChild, 0);
    ...
    realScores.put(1, -6.481670883671237);
    realScores.put(3, -7.006195351795389);
